			...
			foreach ($contacts as $contact) {
				...
				if ($type['id']==$contact['idType']) {
					...
					if($icon==true) { 
						...
						print '<input class="mdl-textfield__input" type="'.$type['icon'].'" id="'.$contact['id'].'" name="value" value="'.$conValue.'" onkeyup="'.$type['icon'].'Check(this)" onfocus="'.$type['icon'].'Check(this)" onblur="checkEmpty(this)" >';
						...
						print '<div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--4-col-tablet mdl-cell--4-col-phone">';
						print '<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  mdl-textfield--full-width">';
						print '<input class="mdl-textfield__input" type="'.$type['icon'].'" name="value" id="'.$contact['id'].'" value="'.$conValue.'" onblur="checkEmpty(this)" onfocus="'.$type['icon'].'Check(this)" onkeyup="'.$type['icon'].'Check(this)">';
						print '<label class="mdl-textfield__label" for="'.$contact['id'].'">'.$type['name'].'</label>';
						print '</div>';
						print '</div>';											
					}
