												...
												foreach ($types as $type) {
													...
													if ($yes==1) {
														...
														foreach ($contacts as $contact) {
															if ($type['id']==$contact['idType']) {
																echo "<tr>";
																echo "<td  class='sfield' onclick=copy(".$contact['id'].") id=b".$contact['id']."><input readonly class='printHide' id=i".$contact['id']." value=".$contact['value']."><span>".$contact['value']."</span>";
